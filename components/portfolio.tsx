            ...
            >
              ...
              <div>
                ...
                <p className="mb-4">
                  ...
                  models ({" "}
                  <span className="text-teal-300"> Node Js/TypeScript </span>,
                  <span className="text-teal-300"> Prisma </span>,
                  <span className="text-teal-300"> Nest Js </span>,
                  <span className="text-teal-300"> PostgreSQL </span>,
                  <span className="text-teal-300"> Redis </span>,
                  <span className="text-teal-300"> AWS </span>,
                  <span className="text-teal-300"> Circle ci </span>,
                  <span className="text-teal-300"> Docker </span>,
                  <span className="text-teal-300"> MongoDB </span> ,etc).
                </p>
                <p className="mb-4">
              ...
              <div>
                <div className="mb-12">
                  <a
                    ...
                    href="https://my-tf-test-bucket-ayan0093.s3.us-east-1.amazonaws.com/AyanModak_Resume.pdf"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <span className="inline-block">
